/*
  # Fix update_portfolio_on_order_complete function to use order_type column

  1. Changes
    - Update update_portfolio_on_order_complete() function to use NEW.order_type instead of NEW.type
    - This fixes the "record 'new' has no field 'type'" error when approving orders
*/
